    ...
    <body class="skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        FUEL STOCK <small>Insert Fuel Stock</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <!-- form start -->
                                <form class="form-horizontal" action="./com.ebox.hovael.db/FuelStock.php" method="POST" id="insertForm">
        ...
        <script>
            ...
            $(document).on('submit', '#insertForm', function () {
                if (!$isDateOk || $('#site').val() === null || !$.isNumeric($('#price').val()) || !$.isNumeric($('#qty').val())) {
