    ...
    <body class="skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        PLANT RATE <small>Insert New Rate</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="Home.php"><i class="fa fa-dashboard"></i> HOVAEL</a></li>
                        <li class="active">Plant Rate</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <form id="insertForm" class="form-horizontal" action="db/SavePlantRate.php" method="POST">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="divtype" class="col-sm-10">
                                                <select id="type" name="type" class="form-control" required="">
                                                    <option value="select" selected="" disabled="">Select Type</option>
                                                    <?php
                                                    include './DBCon.php';
                                                    $res = mysqli_query($con, "SELECT * FROM inventorytype a, inventorycat b WHERE b.id=a.idinventorycat GROUP BY category,model");
                                                    while ($row = mysqli_fetch_array($res)) {
                                                        ?>
                                                        <option value="<?php echo $row[0]; ?>"> <?php echo $row['category'] . " | " . $row['model']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label"> Minimum Rate :</label>
                                            <div id="divrate" class="col-sm-2">
                                                <input id="rate" name="rate" type="text" class="form-control" placeholder="Proposed Rate" required="">
                                            </div>
                                            <label class="col-sm-2 control-label"> Description :</label>
                                            <div id="divhrs" class="col-sm-6">
                                                <textarea id="desc" name="desc" class="form-control" rows="1" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            $(document).on('submit', '#insertForm', function () {
                if ($('#type').val() === null || !$.isNumeric($('#rate').val())) {
