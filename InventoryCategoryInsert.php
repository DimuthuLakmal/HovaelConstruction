        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        INVENTORY CATEGORY <small>Insert Inventory Category</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <!-- form start -->
                                <form class="form-horizontal" action="com.ebox.hovael.db/InventoryCategory.php" method="POST" id="insertForm">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-2 control-label"> Service Time Period :</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="service" class="form-control" id="service" placeholder="Service" required>
                                            </div>
                                        </div>
