                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            include './DBCon.php';
                            $res = mysqli_query($con, "SELECT * FROM inventorytype a , inventorycat b ,plantrate c where $id=c.id and c.idinventorytype=a.id and a.idinventorycat=b.id ");
                            if ($row = mysqli_fetch_array($res)) {
                                ?>

                                <div class="box box-info">
                                    <form id="updateForm" class="form-horizontal" action="db/UpdatePlantRate.php" method="POST">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div class="col-sm-4">
                                                    <input id="rate" name="rate" type="text" class="form-control" value="<?php echo $row['mincharge']; ?>" required="">
                                                </div>
                                                <label class="col-sm-2 control-label"> Description :</label>
                                                <div class="col-sm-4">
                                                    <input id="desc" name="desc" type="text" class="form-control" value="<?php echo $row['description']; ?>">
                                                </div>
                                            </div>
