<?php
session_start();
$_SESSION['table'] = 'internalhirerate';
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        INTERNAL HIRE RATE <small>Insert New Rate</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <form id="insertForm" class="form-horizontal" action="db/SaveInternalHireRate.php" method="POST">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="divhrs" class="col-sm-2">
                                                <input id="hrs" name="hrs" type="text" class="form-control" placeholder="Estimated Hours" required="">
                                            </div>
